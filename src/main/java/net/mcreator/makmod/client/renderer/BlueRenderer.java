...
import net.mcreator.makmod.entity.BlueEntity;
...
public class BlueRenderer extends EntityRenderer<BlueEntity> {
	private static final ResourceLocation texture = new ResourceLocation("mak_mod:textures/entities/bluetexture.png");
	...
	@Override
	public void render(BlueEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
